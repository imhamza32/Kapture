...
open class WHTabbarController: UITabBarController {
    ...
    public var centreButtonContainer : UIView?
    ...
    public func addCenterButtonImage() {
        centerImageView?.image = centerButtonImage
    }
    ...
    public func setupCenetrButton(vPosition : CGFloat ,  buttonClicked: @escaping()->Void )  {
        ...
        centreButtonContainer.applyGradient()
        ...
        centerImageView = centerButtonImageView
        ...
        centreButtonContainer.addSubview(centerImageView!)
        
        centreButtonContainer.addTap {
            buttonClicked()
        }
    }
}
